...
--
-- Host: localhost
-- Generation Time: Aug 17, 2021 at 12:17 AM
...
(68, 'The Definitive Collection', '', 1, NULL),
...
(2, 'BetaBites', 'tech@jd-data.com', '$2y$10$bSUpn7MIAFV/A02g96UjNuMS2piySJy0CUKZ4tUqxiERVVL0eV86K', 0),
(24, 'TEST', 'test@test', '$2y$10$ol71tVJPldbyOHeIaWnTWOYGDnIV2H5Kk1t3hFCpXqaabmQ5/j4/.', 0),
(26, 'admin', 'admin@admin', '$2y$10$SpsjA2uy5FcDnmJO2uApn.cEwuC.YsSEyR2NKlUlzZy8BvlwT7mNW', 1),
(29, '7jhawinkels', '7jhawinkels@tawacollege.school.nz', '$2y$10$IRREVdj7sG5Sn/5j21zEfemaw10yKo4wffWVJzgK2xeaQRHNO9mfe', 1),
(30, 'Graeme', 'client.graeme@project.com', '$2y$10$HeL3JIBPMVQFz3OGe6njte2ny3IbUvm9J96nw/ZRuC6tngsorFxTq', 1);
...
--
ALTER TABLE `users`
  MODIFY `user_id` tinyint(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
